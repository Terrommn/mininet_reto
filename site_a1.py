#!/usr/bin/env python3
# sede a1 monterrey (hub): router-on-a-stick + doble nucleo (ecmp) + servidores dual-homed
...
class SiteA1:
    ...
    # vlans de usuario (con dhcp). la 100 (servidores) usa ip fija
    ...
    def build(self, net):
        ...
        # ip=None para que mininet no asigne 10.0.0.x/8
        ...
        # servidores dual-homed (2 enlaces)
        ...
        # los enlaces wan (eth3/4/5) los agrega el maestro
    ...
    def configure(self):
        ...
        # tags de vlan en el switch de acceso
        for i, vid in enumerate(self.VLANS, start=1):
        ...
        # servidores: salida por los dos cores (ecmp)
    ...
    def start_services(self, dhcp_conf, dns_conf):
        ...
        # web (cd y python3 en el mismo cmd: el cwd no persiste)
        ...
        # ftp (pyftpdlib; -i 0.0.0.0 para escuchar en la ip de servicio del loopback)
    ...
    def start_relay(self):
        ...
        # escucha en las vlans y en los uplinks (por donde vuelve el offer)
